...
public class ComparisonOperations {
    ...
    public static final LispFunction LESSER = new LispFunction(params -> CHECK_CONDITION_FOR_PAIRS.eval(params.prepend(LESSER_CONDITION.quote())), true, LispNumber.class);
    ...
    public static final LispFunction IS_EQUALS = new LispFunction(params -> CHECK_CONDITION_FOR_PAIRS.eval(params.prepend(EQUALS_CONDITION.quote())), true, LispNumber.class);
    ...
    public static final LispFunction GREATER_OR_EQUALS = new LispFunction(params -> CHECK_CONDITION_FOR_PAIRS.eval(params.prepend(GREATER_OR_EQUALS_CONDITION.quote())), true, LispNumber.class);
    ...
    public static final LispFunction LESSER_OR_EQUALS = new LispFunction(params -> CHECK_CONDITION_FOR_PAIRS.eval(params.prepend(LESSER_OR_EQUALS_CONDITION.quote())), true, LispNumber.class);
}
